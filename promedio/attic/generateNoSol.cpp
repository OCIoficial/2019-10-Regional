...
int main(int argc, char const *argv[]) {
  ...
  std::uniform_int_distribution<int> elemOriginalDist(0, 100);
  int elemBound = elemOriginalDist(rng);
  std::uniform_int_distribution<int> elemDist(0, elemBound);
  std::uniform_int_distribution<int> targetDist(elemBound + 1, 100);
